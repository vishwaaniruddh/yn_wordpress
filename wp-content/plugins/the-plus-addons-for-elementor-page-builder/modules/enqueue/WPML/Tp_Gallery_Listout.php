...
class Tp_Gallery_Listout extends L_WPML_Elementor_Module_With_Items {
	...
	protected function get_title( $field ) {
		switch($field) {
			case 'loop_title':
				return esc_html__( 'Gallery Listout : Title', 'tpebl' );

			case 'loop_content_caption':
				return esc_html__( 'Gallery Listout : Caption', 'tpebl' );
