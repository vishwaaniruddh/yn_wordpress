...
$footer_blocks = function_exists('loobek_get_footer_block_options')? loobek_get_footer_block_options(): array();
...
$options[] = array(
				...
				,'options'	=> array(
									...
									,'wider' 	=> esc_html__('Wider', 'themesky')
								)
			);			
...
$options[] = array(
				...
				,'options'	=> array(
									...
									,'v11' 		=> esc_html__('Header Layout 11', 'themesky')
									,'v12' 		=> esc_html__('Header Layout 12', 'themesky')
								)
			);
...
$options[] = array(
				...
				,'label'	=> esc_html__('Transparent Header Logo', 'themesky')
				,'desc'		=> ''
				,'type'		=> 'upload'
			);			
